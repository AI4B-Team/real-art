    ...
    <div>
      ...
      <div className="flex gap-3.5 overflow-x-auto pb-2 scrollbar-hide">
        {earningMethods.map((e) => (
          <div key={e.title} className={`border rounded-[16px] p-6 flex flex-col gap-3 transition-all hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,0.08)] min-w-[220px] flex-shrink-0 ${e.highlight ? "bg-accent border-accent" : "bg-card border-foreground/[0.08]"}`}>
