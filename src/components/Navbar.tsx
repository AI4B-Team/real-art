...
import { Search, Menu, Grid3X3, Star, Users, Trophy, BarChart3, Upload, Pen, Sparkles, FileText, X, Layout } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[300] h-16 px-6 md:px-12 flex items-center justify-between bg-background/96 backdrop-blur-xl border-b border-foreground/[0.08]">
      ...
      {/* Right Side Actions: Upload Art | Log In | Join Free | ☰ */}
      <div className="flex items-center gap-1.5 shrink-0">
        <Link
          to="/upload"
          className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-[0.82rem] font-medium text-foreground hover:bg-foreground/[0.06] transition-colors"
        >
