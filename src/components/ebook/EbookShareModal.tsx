...
export default function EbookShareModal({ open, onOpenChange, projectName }: EbookShareModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="<DialogContent className="sm:max-w-xl p-0 gap-0 rounded-2xl overflow-hidden max-h-[85vh] flex flex-col"> p-0 gap-0 rounded-2xl overflow-hidden max-h-[85vh] flex flex-col">
