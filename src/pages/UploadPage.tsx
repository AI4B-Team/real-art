              ...
              <div className="flex flex-col gap-7">
                ...
                <div>
                  ...
                  <button
                    ...
                    className={`flex items-center justify-between w-full p-4 rounded-xl border text-left transition-all ${similarProducts ? "border-accent bg-accent/[0.04]" : "border-foreground/[0.1]"}`}
                  >
                    <div className="flex items-center gap-3">
