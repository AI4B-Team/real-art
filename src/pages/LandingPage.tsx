...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Minimal top nav */}
      <header className="fixed top-0 inset-x-0 z-50 h-16 flex items-center justify-between px-3 md:px-5 bg-background/80 backdrop-blur-md border-b border-foreground/[0.06]">
        <Logo to="/landing" />
