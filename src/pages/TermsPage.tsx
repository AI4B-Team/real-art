...
const sections = [
  { id: "acceptance", title: "1. Acceptance of terms", content: "By accessing or using REAL CREATOR (\"the Platform\"), you agree to be bound by these Terms of Service (\"Terms\"). If you do not agree to these Terms, do not use the Platform.\n\nThese Terms apply to all visitors, users, and creators. We may update these Terms from time to time. Continued use of the Platform after changes are posted constitutes your acceptance of the updated Terms." },
  { id: "eligibility", title: "2. Eligibility", content: "You must be at least 13 years old to use REAL CREATOR. If you are under 18, you represent that you have your parent or guardian's permission to use the Platform.\n\nBy creating an account, you represent that the information you provide is accurate and that you are authorized to agree to these Terms." },
  ...
  { id: "upload", title: "4. Content you upload", content: "By uploading content to REAL CREATOR, you represent and warrant that:\n\n(a) You own or have the necessary rights to the content you upload.\n(b) The content does not infringe any third-party intellectual property, privacy, or other rights.\n(c) The content does not violate any applicable law.\n(d) You have the right to grant REAL CREATOR the license described below.\n\nYou grant REAL CREATOR a worldwide, non-exclusive, royalty-free license to host, display, distribute, and promote your content on the Platform and in connection with the Platform's services.\n\nYou retain all ownership rights to your content. We do not claim ownership of anything you upload." },
  ...
  { id: "ip", title: "10. Intellectual property", content: "REAL CREATOR's name, logo, design, and underlying software are our intellectual property. You may not reproduce, distribute, or create derivative works from our brand assets without express written permission.\n\nUser-uploaded content remains the property of the creator. REAL CREATOR claims no ownership over uploaded images." },
  { id: "disclaimers", title: "11. Disclaimers", content: "THE PLATFORM IS PROVIDED \"AS IS\" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. REAL CREATOR DOES NOT WARRANT THAT:\n\n(a) The Platform will be uninterrupted or error-free\n(b) Content on the Platform is accurate, complete, or current\n(c) The Platform or its servers are free of viruses or harmful components\n\nTO THE FULLEST EXTENT PERMITTED BY LAW, REAL CREATOR DISCLAIMS ALL WARRANTIES, INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT." },
  { id: "liability", title: "12. Limitation of liability", content: "TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, REAL CREATOR SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, OR GOODWILL.\n\nREAL CREATOR'S TOTAL LIABILITY FOR ANY CLAIMS ARISING UNDER THESE TERMS SHALL NOT EXCEED THE GREATER OF (A) $100 OR (B) THE AMOUNT YOU PAID TO REAL CREATOR IN THE 12 MONTHS PRECEDING THE CLAIM." },
