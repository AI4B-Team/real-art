...
const sections = [
  ...
  { id: "affiliate", title: "7. Affiliate program", content: "The REAL ART affiliate program allows creators to earn commission when users they refer purchase REAL CREATOR subscriptions.\n\nAffiliate commissions are calculated based on verified referrals tracked through unique affiliate links. Commission rates and payment schedules are described in the Affiliates page and may be updated from time to time.\n\nWe reserve the right to suspend affiliate earnings if we detect fraudulent referral activity, including self-referrals, incentivized clicks, or bot-generated traffic." },
  { id: "galleries", title: "8. Private galleries and access codes", content: "Creators may establish private galleries accessible only via access codes. The creator (\"Gallery Owner\") is solely responsible for:\n\n(a) The content they publish in private galleries\n(b) Managing and distributing access codes responsibly\n(c) Ensuring that access code recipients are authorized users\n\nREAL ART is not responsible for unauthorized access resulting from misuse or distribution of access codes by the Gallery Owner." },
